...
#define LIFT_MIN_ANGLE_RIGHT -19887
#define LIFT_MAX_ANGLE_LEFT 19885
#define LIFT_MIN_ANGLE_LEFT 181

#define STRETCH_1_MIN_ANGLE_RIGHT -24000
#define STRETCH_1_MAX_ANGLE_RIGHT 38000
#define STRETCH_1_MIN_ANGLE_LEFT -24000
#define STRETCH_1_MAX_ANGLE_LEFT 38000
